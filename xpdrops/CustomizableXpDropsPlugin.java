...
import net.runelite.client.plugins.xpdrops.attackstyles.WeaponType;
import net.runelite.client.plugins.xpdrops.config.XpDropsConfig;
import net.runelite.client.plugins.xpdrops.overlay.XpDropOverlayManager;
import net.runelite.client.plugins.xpdrops.predictedhit.Hit;
import net.runelite.client.plugins.xpdrops.predictedhit.XpDropDamageCalculator;
import net.runelite.client.plugins.xpdrops.predictedhit.npcswithscalingbonus.ChambersLayoutSolver;
