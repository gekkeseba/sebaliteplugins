...
import net.runelite.client.plugins.xpdrops.CustomizableXpDropsPlugin;
import net.runelite.client.plugins.xpdrops.XpDrop;
...
import net.runelite.client.plugins.xpdrops.config.XpTrackerSkills;
